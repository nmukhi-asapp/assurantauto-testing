...
**Rules**:
  1. ✅ Agent offers the self-service portal website before addressing the caller's claim question
...
**Rules**:
  1. ✅ Agent offers the self-service portal website to the caller
